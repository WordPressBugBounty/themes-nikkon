...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( !is_archive() && get_theme_mod( 'nikkon-blog-layout' ) == 'blog-blocks-layout' || is_archive() && get_theme_mod( 'nikkon-blog-cats-blocks' ) == 1 ) : ?>
		...
		<?php if ( get_theme_mod( 'nikkon-blog-blocks-style' ) == 'blog-style-imgblock' ) : ?>
			...
			<div class="blog-post-blocks-inner <?php echo ( get_theme_mod( 'nikkon-blog-post-shape' ) ) ? sanitize_html_class( get_theme_mod( 'nikkon-blog-post-shape' ) ) : sanitize_html_class( 'blog-post-shape-square' ); ?> <?php echo ( get_theme_mod( 'nikkon-blog-blocks-remove-border' ) ) ? sanitize_html_class( 'blocks-no-border' ) : ''; ?>">
			    ...
			    <a href="<?php echo esc_url( get_permalink() ); ?>" class="blog-post-blocks-inner-a">
			    	<div class="blog-blocks-content-inner">
			        	<header class="entry-header">
			        		<?php
			        		$post_title_tag = get_theme_mod( 'nikkon-seo-blog-post-title-tag', customizer_library_get_default( 'nikkon-seo-blog-post-title-tag' ) );
			        		the_title( '<h'.esc_attr( $post_title_tag ).' class="entry-title">', '</h'.esc_attr( $post_title_tag ).'>' ); ?>
